...
for zone in zones:
    raster_to_valid_extent_shapefile(f"../data/RG/DTM/NAC_DTM_REINER{zone}.tiff",
                                     f"../data/RG/DTM/Emprises/emprise_RG{zone}.shp")

    comble_trous_dtm(
        input_raster_path=f"../data/RG/DTM_crop/RG{zone}_clip_02.TIF",
        output_raster_path=f"../data/RG/DTM_interpolate/RG{zone}_interpolation_IDW_02.TIF",
        method='idw',
        smooth=True,
        sigma=1,
        idw_power=4
    ...
    crop(raster_path=f"../data/RG/DTM_interpolate/RG{zone}_interpolation_IDW_02.TIF",
        shapefile_path=f"../data/RG/DTM/Emprises/emprise_RG{zone}.shp",
        output_path=f"../data/RG/DTM_interpolate/RG{zone}_interpolation_IDW_02_crop.TIF")

    crop(raster_path=f"../data/RG/DTM_interpolate/RG{zone}_interpolation_IDW_02_fiabilite.TIF",
        shapefile_path=f"../data/RG/DTM/Emprises/emprise_RG{zone}.shp",
        output_path=f"../data/RG/DTM_interpolate/RG{zone}_interpolation_IDW_02_crop_fiabilite.TIF")
